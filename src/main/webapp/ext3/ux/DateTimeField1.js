				...
				Ext.util.Observable,
				{
					...
					fixPrecision : function(value) {
						...
						if (!this.field.allowDecimals
								|| this.field.decimalPrecision == -1 || nan
								|| !value) {
							return nan ? '' : value;
						}
...
Ext.extend(Ext.ux.form.TimePickerField, Ext.form.Field, {
	...
	onRender : function(ct, position) {
		Ext.ux.form.TimePickerField.superclass.onRender
	...
	getValue : function() {
		...
		return String.leftPad(v.h, 2, '0') + ':' + String.leftPad(v.m, 2, '0')
...
Ext.ux.form.DateTimeField = Ext.extend(Ext.form.DateField, {
	...
	validateValue : function() {
		if (this.validator && typeof this.validator == 'function') {
			var ret = this.validator.call(this, this.getValue());
			if (ret == true)
				this.clearInvalid();
			else if (ret === false)
				this.markInvalid('this field is invalid');
			else if (typeof ret == 'string')
				this.markInvalid(ret);
			return ret;
		}
		return true
	},
...
Ext.reg('datetimefield1', Ext.ux.form.DateTimeField);

var ClearableDateTimeField = Ext.extend(Ext.ux.form.DateTimeField, {
	initComponent : function() {
		this.triggerConfig = {
			tag : 'span',
		...
		ClearableDateTimeField.superclass.initComponent.call(this);
	},
	...
	onDestroy : function() {
		...
		ClearableDateTimeField.superclass.onDestroy.call(this);
	},
